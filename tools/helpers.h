...
extern int helpers_first_tag(nfc_connstring **device_connstring, FreefareTag *tag);
extern int helpers_next_tag(nfc_connstring **device_connstring, FreefareTag *tag);
